      ...
      <div className="container-x">
        ...
        <header className="max-w-3xl border-b border-border pb-10">
          ...
          <p className="mt-4 text-xs text-muted">
            Sin precios aquí: cada configuración es un punto de partida y la cotización se cierra contigo en la consultoría.
          </p>
        </header>
        ...
        <p className="mt-12 max-w-2xl text-xs leading-relaxed text-muted">
          Todas las configuraciones son orientativas y totalmente personalizables: cambia cualquier componente en el
          configurador y la compatibilidad se valida al instante. El montaje, el test de 24 h y la puesta a punto están
          incluidos en todos los equipos PC LAB.
        </p>
      </div>
      <Cta />
    </div>
