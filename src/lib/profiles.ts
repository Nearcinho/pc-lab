...
export const PROFILES: Record<UseCase, Record<BudgetTier, BuildSelection>> = {
  gaming: {
    1: { cpu: "cpu-r5-7600", motherboard: "mb-b650m", gpu: "gpu-rtx4060", ram: "ram-16", storage: "ssd-1tb", cooling: "cool-ax120", psu: "psu-gold-550", case: "case-nxht", os: "os-win-home" },
  ...
  streaming: {
    1: { cpu: "cpu-r5-7600", motherboard: "mb-b650m", gpu: "gpu-rtx4060", ram: "ram-32", storage: "ssd-1tb", cooling: "cool-ax120", psu: "psu-gold-550", case: "case-nxht", os: "os-win-home" },
  ...
  productividad: {
    1: { cpu: "cpu-r5-7600", motherboard: "mb-b650m", gpu: "gpu-rtx4060", ram: "ram-16", storage: "ssd-1tb", cooling: "cool-ax120", psu: "psu-gold-550", case: "case-nxht", os: "os-win-home" },
    2: { cpu: "cpu-r7-7700x", motherboard: "mb-b650m", gpu: "gpu-rtx4060", ram: "ram-32", storage: "ssd-2tb", cooling: "cool-aio240", psu: "psu-gold-650", case: "case-lancool", os: "os-win-home" },
